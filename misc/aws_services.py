service_names = {'AWSAmplify': 'AWS Amplify',
                 ...
                 'AWSB2Bi': 'AWS B2B Data Interchange',
                 ...
                 'AWSElementalInference': 'AWS Elemental Inference',
                 ...
                 'AmazonEVSLicensesIncluded': 'Amazon Elastic VMware Service (LI)',
                 ...
                 'awskms': 'AWS Key Management Service', 'awswaf': 'AWS WAF',
...
not_expected_services = {'AWS Data Pipeline', 'AWSAppRunner', 'AWSElementalMediaStore', 'AWSGlueElasticViews',
                         'AWSGreengrass', 'AWSIoTAnalytics', 'AWSIoTEvents', 'AWSIoTThingsGraph', 'AWSM2', 'AWSMDC',
                         'AWSMigrationHubRefactorSpaces', 'AWSRoboMaker', 'AWSServiceCatalog', 'AmazonChime',
                         'AmazonCloudDirectory', 'AmazonCloudSearch', 'AmazonCognitoSync', 'AmazonDeadline',
                         'AmazonEI', 'AmazonETS', 'AmazonFinSpace', 'AmazonForecast', 'AmazonFraudDetector',
                         'AmazonInspector', 'AmazonLookoutEquipment', 'AmazonLookoutMetrics', 'AmazonLookoutVision',
                         'AmazonML', 'AmazonMacie', 'AmazonMonitron', 'AmazonPinpoint', 'AmazonQLDB', 'AmazonSWF',
                         'AmazonSimpleDB', 'AmazonSumerian', 'AmazonTimestream', 'AmazonWAM', 'AmazonWorkDocs',
                         'AmazonWorkLink', 'AmazonWorkMail', 'AmazonWorkSpacesThinClient', 'AppFlow', 'CodeCatalyst',
                         'CodeGuru', 'IngestionService', 'SimSpaceWeaver', 'VMwareCloudOnAWS', 'auditmanager',
                         'datapipeline'}
